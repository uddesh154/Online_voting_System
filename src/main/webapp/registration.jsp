...
if(fullname!=null && username!=null && gender!=null && phoneno!=null && address!=null && password!=null )
{
try
{
	  ...
	  Statement stmt = con.createStatement();
			stmt.executeUpdate("insert into voter values('"+fullname+"','"+username+"','"+gender+"','"+phoneno+"','"+address+"','"+password+"')");
			out.println("Success");
}
catch(Exception e)
{
